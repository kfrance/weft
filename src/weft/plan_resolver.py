...
- Plan IDs (e.g., "fix-subagent" -> ".weft/tasks/fix-subagent.md")
- Full paths (e.g., ".weft/tasks/fix-subagent.md" -> unchanged)
...
class PlanResolver:
    ...
    def resolve(user_input: str | Path, cwd: Path | None = None) -> Path:
        ...
        1. Plan ID (e.g., "fix-subagent") -> searches .weft/tasks/<plan_id>.md
        2. Full/relative path (e.g., ".weft/tasks/plan.md") -> resolves to absolute
        ...
        # Case 3: Plan ID - search in .weft/tasks/
        try:
