...
global ~/.weft/dspy_cache/ and worktree-local cache directories.
"""
...
def sync_cache_to_worktree(
    ...
    Args:
        source: Source cache directory (e.g., ~/.weft/dspy_cache)
...
def sync_cache_from_worktree(
    ...
    Args:
        ...
        dest: Destination global cache directory (e.g., ~/.weft/dspy_cache)
...
def get_global_cache_dir() -> Path:
    ...
    Returns:
        Path to global cache directory (~/.weft/dspy_cache)
    """
...
def get_worktree_cache_dir(worktree_path: Path) -> Path:
    ...
    Returns:
        Path to worktree cache directory (worktree/.weft/dspy_cache)
    """
    return worktree_path / ".weft" / "dspy_cache"
